                            ...
                            <div class="card-body">
                                ...
                                <div class="container">
                                    <div class="row" style="  display: flex;justify-content: space-between;">
                                        <h4 class="mt-0 header-title">Jadwal Kegiatan</h4>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Jadwal Kegiatan
                                                </h5>
                                            ...
                                            <form action="{{ route('admin.jadwal-kegiatan.store') }}" method="POST"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="deskripsi">Tanggal Kegiatan</label>
                                        ...
                                        @foreach ($datas as $data)
                                            ...
                                            <div class="modal fade" id="Edit-{{ $data->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Edit Jadwal
                                                                Kegiatan
                                                            </h5>
                                                            <button type="button" class="close" data-dismiss="modal"
                                                                aria-label="Close">
                                                        ...
                                                        <form
                                                            action="{{ route('admin.jadwal-kegiatan.edit', $data->id) }}"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form id="deleteForm" method="POST"
                                                                action="{{ route('admin.jadwal-kegiatan.delete', $data->id) }}">
                                                                @csrf
                                                                @method('Delete')
                                                                <button type="submit"
